...
const blogPosts = [
  {
    ...
    excerpt: 'Po dveh letih premora se The Drinkers vračajo z veliko turnejo po Sloveniji in regiji.',
  ...
  },
  {
    ...
    excerpt: 'Poglejte, kako poteka snemanje našega najnovejšega albuma v studiu.',
    content: 'Full content...',
  ...
  },
  {
    ...
    excerpt: 'Postani član VIP Lounge in dobii dostop do ekskluzivnih vsebin, vstopnic in popustov.',
    content: 'Full content...',
    publishedAt: '2026-03-10',
    author: 'Community Manager',
    image: '/images/blog/vip-lounge.jpg',
  ...
  },
  {
    ...
    excerpt: 'Odkrij najnovejšo kolekcijo The Drinkers mercha - omejene edicije in ekskluzivni dizajni.',
    content: 'Full content...',
    publishedAt: '2026-03-05',
    author: 'Merch Team',
    image: '/images/blog/merch-2026.jpg',
    ...
    <>
      ...
      <section className="relative h-[60vh] flex items-center justify-center bg-rock-black">
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-gradient mb-4">BLOG</h1>
          <p className="text-xl text-text-gray">Novice, zgodbe in posodobitve</p>
        </div>
      </section>
