...
export const metadata: Metadata = {
  title: "Kontakt",
  description:
    "Kontaktiraj skupino The Drinkers za booking, sodelovanja in vprašanja.",
};
          ...
          <div className="space-y-6">
            <div className="card p-6">
              ...
              <p className="text-text-gray">
                Vstopnice lahko rezerviraš preko naše spletne strani pri
                posameznem koncertu ali preko partnerjev kot so Eventim,
                Ticketmaster in Stoparje.
              </p>
            </div>
            <div className="card p-6">
              <h3 className="text-xl font-bold text-white mb-2">
              ...
              <p className="text-text-gray">
                Da! Za profesionalne fotografije s koncertov nas kontaktirajte
                preko emaila in dogovorili se bomo za podrobnosti.
              </p>
            </div>
            <div className="card p-6">
              <h3 className="text-xl font-bold text-white mb-2">
              ...
              <p className="text-text-gray">
                Dostop do ekskluzivnega Drinkers&apos; Bar je na voljo imetnikom
                VIP vstopnic in članom našega fan kluba. Več informacij najdeš
                na strani Drinkers&apos; Bar.
              </p>
            </div>
            <div className="card p-6">
              <h3 className="text-xl font-bold text-white mb-2">
              ...
              <p className="text-text-gray">
                Vse izdelke lahko naročite preko naše spletne trgovine. Za večja
                naročila ali posebne zahteve nas kontaktirajte direktno.
              </p>
            </div>
          </div>
        </div>
      ...
      <Section background="darker">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-crimson mb-6">
            BOOKING IN POVPRAŠEVANJA
          </h2>
          <p className="text-lg text-text-gray mb-8">
            Za booking koncertov, gostovanj ali drugih dogodkov nas
            kontaktirajte na:
          </p>
