...
export async function GET() {
  return NextResponse.json({
    ...
    theDrinkersKeywords: {
      brand: ['The Drinkers', 'The Drinkers band', 'The Drinkers Slovenija', 'thedrinkers.net'],
      genre: ['Slovenian rock', 'Slo rock', 'rock band Slovenia', 'Slovenian music', 'booze rock', 'hard rock'],
      location: ['Litija band', 'Ljubljana concert', 'Slovenia rock', 'Orto Bar'],
      songs: ['Pijemo ga radi', 'Lepi in trezni', 'Žeja', 'Pivolucija', 'Hajdi', 'Deset majhnih jagrov', 'Recidiv'],
      events: ['concert Slovenia', 'live music Ljubljana', 'rock concert 2026', 'The Drinkers concert'],
    },
    tools: [
