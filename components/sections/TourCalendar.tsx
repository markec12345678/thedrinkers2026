...
export function TourCalendar() {
  const upcomingShows = tourDates.filter((date) => !date.soldOut);
  const pastShows = tourDates.filter(
                ...
                >
                  ...
                  <div className="text-center md:text-right">
                    {show.soldOut ? (
                      ...
                      <>
                        <div className="text-2xl font-bold text-crimson mb-2">
                          {show.price}
                        </div>
                        {show.ticketUrl && (
              ...
              {pastShows.slice(0, 3).map((show, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent p-4 flex flex-col justify-end">
                    <h4 className="text-lg font-bold text-crimson">
                      {show.venue}
                    </h4>
