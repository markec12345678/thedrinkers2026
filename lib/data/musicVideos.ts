...
export const musicVideos = [
  {
    ...
    thumbnail: "https://i.ytimg.com/vi/5bYFArOho7U/maxresdefault.jpg",
    duration: "3:45",
    views: "21K+",
    year: 2010,
    album: "De Best Od",
  ...
  },
  {
    ...
    thumbnail: "https://i.ytimg.com/vi/hkHHvb2eDb4/maxresdefault.jpg",
    duration: "3:30",
    views: "15K+",
    year: 2001,
    album: "De Best Od",
  ...
  },
  {
    ...
    thumbnail: "https://i.ytimg.com/vi/7HHx9c3YnMQ/maxresdefault.jpg",
    duration: "4:12",
    views: "8K+",
    year: 2001,
    album: "De Best Od",
  ...
  },
  {
    ...
    thumbnail: "https://i.ytimg.com/vi/oKa8Y_rwhD0/maxresdefault.jpg",
    duration: "3:58",
    views: "5K+",
    year: 2014,
    album: "Hajdi",
  ...
  },
  {
    ...
    thumbnail: "https://i.ytimg.com/vi/FFKtFXLONR0/maxresdefault.jpg",
    duration: "4:05",
    views: "2.2K+",
    year: 2013,
    album: "Recidiv",
  ...
  },
  {
    ...
    thumbnail: "https://i.ytimg.com/vi/d3ygw0J_VgQ/maxresdefault.jpg",
    duration: "3:52",
    views: "3K+",
    year: 2016,
  ...
  },
  {
    ...
    thumbnail: "https://i.ytimg.com/vi/aU32hb58g4E/maxresdefault.jpg",
    duration: "4:20",
    views: "2K+",
    year: 2007,
    album: "Recidiv",
  ...
  },
  {
    ...
    thumbnail: "https://i.ytimg.com/vi/xwL-SFI5DTI/maxresdefault.jpg",
    duration: "3:38",
    views: "1.5K+",
    year: 2003,
    album: "Žeja",
...
// Videos by album
export const videosByAlbum = musicVideos.reduce(
  (acc, video) => {
    if (!acc[video.album]) {
      acc[video.album] = [];
    }
...
export const videoCategories = {
  ...
  mostViewed: [...musicVideos].sort((a, b) => {
    const aViews = parseInt(
      a.views.replace("K+", "000").replace("M+", "000000"),
    );
    const bViews = parseInt(
      b.views.replace("K+", "000").replace("M+", "000000"),
    );
