...
async function seedTestData() {
  ...
  try {
    ...
    try {
      await client.query(`INSERT INTO product (name, description, price, compare_at_price, stock, sku, category, images, sizes, colors, featured, active) VALUES
    ...
    try {
      await client.query(`INSERT INTO tour_date (tour_name, venue, city, country, date, time, ticket_url, ticket_price, status, capacity, sold_tickets, featured, active) VALUES
    ...
    try {
      await client.query(`INSERT INTO album (title, release_date, cover_image, description, label, genre, total_tracks, featured, active) VALUES
    ...
    try {
      await client.query(`INSERT INTO "user" (name, email, email_verified, membership_tier, display_name) VALUES
