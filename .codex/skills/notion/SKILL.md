...
> Auto-generated by Composio Skills Extension on 2026-03-27T09:33:16.576Z
...
2. Full Notion: {'type': 'code', 'code': {...}} for complex blocks.
   Auto-features: Markdown parsing (**bold** _italic_ ~~strike~~ `code` [link](url)), text splitting at 2000 chars.
...
| `mcp__composio__NOTION_APPEND_BLOCK_CHILDREN`     | DEPRECATED: Use NOTION*APPEND_TEXT_BLOCKS, NOTION*... |
...
| `mcp__composio__NOTION_CREATE_COMMENT`            | Adds a comment to a Notion page (via `parent*page*... |
